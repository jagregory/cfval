...
func TestSchemaTypeValidation(t *testing.T) {
	...
	if _, errs := schema.Validate(parse.IntrinsicFunction{"Ref", map[string]interface{}{"Ref": "StringParam"}}, ctx); errs != nil {
		t.Error("Should pass when Ref is correct type", errs)
	}

	if _, errs := schema.Validate(parse.IntrinsicFunction{"Ref", map[string]interface{}{"Ref": "NumberParam"}}, ctx); errs == nil {
		t.Error("Should fail when Ref is incorrect type")
	}

	if _, errs := schema.Validate(parse.IntrinsicFunction{"Fn::GetAtt", map[string]interface{}{"Fn::GetAtt": []interface{}{"Resource1", "Name"}}}, ctx); errs != nil {
		t.Error("Should pass when GetAtt is correct type", errs)
	}

	if _, errs := schema.Validate(parse.IntrinsicFunction{"Fn::GetAtt", map[string]interface{}{"Fn::GetAtt": []interface{}{"Resource1", "ID"}}}, ctx); errs == nil {
...
func TestSchemaArrayValidation(t *testing.T) {
	...
	if _, errs := schema.Validate([]interface{}{"abc", parse.IntrinsicFunction{"Ref", map[string]interface{}{"Ref": "Target"}}}, ctx); errs != nil {
		t.Error("Should pass when value is an array with Refs of the correct type", errs)
	}

	if _, errs := schema.Validate([]interface{}{"abc", parse.IntrinsicFunction{"Ref", map[string]interface{}{"Ref": "ArrayTarget"}}}, ctx); errs == nil {
		t.Error("Should fail when value is an array with Refs of the wrong type")
	}

	if _, errs := schema.Validate(parse.IntrinsicFunction{"Ref", map[string]interface{}{"Ref": "ArrayTarget"}}, ctx); errs != nil {
		t.Error("Should pass when value is a Ref of the correct type is used for whole value", errs)
	}

	if _, errs := schema.Validate(parse.IntrinsicFunction{"Ref", map[string]interface{}{"Ref": "Target"}}, ctx); errs == nil {
