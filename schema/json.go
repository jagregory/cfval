...
func validateJSON(property Schema, value interface{}, self SelfRepresentation, context []string) (reporting.ValidateResult, reporting.Failures) {
	switch t := value.(type) {
...
func validateJSONMap(property Schema, value map[string]interface{}, self SelfRepresentation, context []string) (reporting.ValidateResult, reporting.Failures) {
...
func validateJSONArray(property Schema, value []interface{}, self SelfRepresentation, context []string) (reporting.ValidateResult, reporting.Failures) {
	failures := make(reporting.Failures, 0, 100)
